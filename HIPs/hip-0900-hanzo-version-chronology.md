...
| 4.0 | 2026-02-14 | GPU-native + native DEX with  | Sovereign L1 on the Lux-family primary chain template (LP-134); AIVM GPU-resident with 8 precompiles (0x0a01--0x0a08); HMM cross-listed via ; FHE inference promoted to production; Proof-of-AI mining. | `hanzo-4-0-launch` |
...
1. **DEX --- HMM (Hanzo Market Maker).** The native AI-compute
   ...
   and Zoo DEX via  (LP-310). Registered at
   `h_0 + 12`.
