...
| [HIP-0044](./HIPs/hip-0044-api-gateway-standard.md) | Hanzo Gateway Standard | Standards Track | Infrastructure | Active |
...
| [HIP-0085](./HIPs/hip-0085-wallet-pq-account-type.md) | Wallet PQ Account Type (ML-DSA-65 native, 48-byte Ac... | Standards Track | Cryptography | Proposed |
| [HIP-0086](./HIPs/hip-0086-tx-auth-envelope.md) | TxAuthEnvelope (typed PQ transaction signing) | Standards Track | Cryptography | Proposed |
| [HIP-0087](./HIPs/hip-0087-pq-permit.md) | PQ Permit (replaces EIP-2612) | Standards Track | Cryptography | Proposed |
| [HIP-0088](./HIPs/hip-0088-session-kem.md) | Session KEM (ML-KEM-768/1024 for P2P) | Standards Track | Cryptography | Proposed |
...
| [HIP-0116](./HIPs/hip-0116-plugin-vm-model.md) | Hanzo Plugin & VM Model — Standalone-plus-Plugin Ser... | Standards Track | Infrastructure | Draft |
...
| [HIP-0126](./HIPs/hip-0126-integrations-connectors-and-the-extension-runtime.md) | Integrations, Connectors & the Extension Runtime — One Registry, One Way | Standards Track | Interface | Draft |
